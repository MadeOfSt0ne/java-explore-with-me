...
import ru.practicum.explore.event.interfaces.PublicEventService;
...
public class PublicEventController {
    ...
    @GetMapping
    public List<EventShortDto> getEventsFiltered(@RequestParam(value = "text", required = false) String text,
