...
CREATE TABLE IF NOT EXISTS event_comments (
    ...
    CONSTRAINT FK_EVENT_COMMENT_ON_AUTHOR FOREIGN KEY (author_id) REFERENCES users (id),
    CONSTRAINT FK_EVENT_COMMENT_ON_EVENT FOREIGN KEY (event_id) REFERENCES events (id)
);